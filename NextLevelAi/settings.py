"""
Django settings for NextLevelAi project.
...
SECRET_KEY = 'django-insecure-w^$00d&@_rdy6)!0ir_-=@ys#=iz4hqd=2g2kfl#fte1!x4_fx'
...
WSGI_APPLICATION = 'NextLevelAi.wsgi.application'
